...
def copy_prototype_draft(
    ...
    copied_generation = Generation(
        ...
        curriculum_compliance_enabled=generation.curriculum_compliance_enabled,
        include_compliance_card=generation.include_compliance_card,
        curriculum_document_ids=generation.curriculum_document_ids,
        created_at=now_iso,
        updated_at=now_iso,
        status="ready",
        error_message=None,
